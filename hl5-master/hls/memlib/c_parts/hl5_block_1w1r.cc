...
// Generated by bdw_memgen 25.02-p001
// Fri Mar 20 18:30:00 EDT 2026
...
#ifdef STRATUS_HLS
   sc_uint<32> hl5_block_1w1r::write0(sc_uint<16> A0, sc_uint<32> D0, bool WE0, bool CE0, sc_uint<32> WEM0) {
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   void hl5_block_1w1r::nop0(bool WE0, bool CE0, sc_uint<32> WEM0) {
      CYN_BIND(WE0,this->WE0);
      CYN_BIND(CE0,this->CE0);
      CYN_BIND(WEM0,this->WEM0);
      HLS_SET_PARAM( "access_port", 1 );
...
#endif	// STRATUS_HLS
#ifdef STRATUS_HLS
   sc_uint<32> hl5_block_1w1r::read1(sc_uint<16> A1, bool CE1) {
      sc_uint<32> Q1;
      CYN_BIND(A1,this->A1);
      CYN_BIND(Q1,this->Q1);
...
const unsigned long hl5_block_1w1r::pipelined = 0;
const float hl5_block_1w1r::area = 100;
const float hl5_block_1w1r::delay = 0.2;
const float hl5_block_1w1r::setup_time = 0.06;
...
const unsigned long hl5_block_1w1r::bits_per_maskbit_WEM0 = 1;
const unsigned long hl5_block_1w1r::latency_CE1 = 1;
const unsigned long hl5_block_1w1r::latency_A1 = 1;
const unsigned long hl5_block_1w1r::reg_mem_inputs = 0;
const unsigned long hl5_block_1w1r::reg_mem_outputs = 0;
const unsigned long hl5_block_1w1r::regs_at_mem_inputs = 0;
const unsigned long hl5_block_1w1r::regs_at_mem_outputs = 0;
const unsigned long hl5_block_1w1r::regs_at_mod_inputs = 0;
const unsigned long hl5_block_1w1r::regs_at_mod_outputs = 0;
