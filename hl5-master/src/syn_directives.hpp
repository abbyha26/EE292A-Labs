...
//Pipeline Execute unit
#if defined(PIPE_SOFT_STALL1)
    #define PIPELINE HLS_PIPELINE_LOOP(SOFT_STALL, 1, "soft input stall pipe")
#elif defined(PIPE_SOFT_STALL2)
    #define PIPELINE HLS_PIPELINE_LOOP(SOFT_STALL, 2, "soft input stall pipe")
#elif defined(PIPE_SOFT_STALL3)
    #define PIPELINE HLS_PIPELINE_LOOP(SOFT_STALL, 3, "soft input stall pipe")
#else
    #define PIPELINE
#endif

#if defined(LATENCY_ACHIEVABLE)
    #define LATENCY HLS_CONSTRAIN_LATENCY( 1, HLS_ACHIEVABLE, "main thread")
#elif defined(LATENCY_INFINITE)
    #define LATENCY HLS_CONSTRAIN_LATENCY( 1, HLS_INFINITE, "main thread")
#else
    #define LATENCY
#endif
